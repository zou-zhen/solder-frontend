  ...
  })()(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          const _chrome_shim = require('./chrome/chrome_shim.js')

          const chromeShim = _interopRequireWildcard(_chrome_shim)

          const _firefox_shim = require('./firefox/firefox_shim.js')

          const firefoxShim = _interopRequireWildcard(_firefox_shim)

          const _safari_shim = require('./safari/safari_shim.js')

          const safariShim = _interopRequireWildcard(_safari_shim)

          const _common_shim = require('./common_shim.js')
      ...
      3: [
        function (require, module, exports) {
          ...
          const _getusermedia = require('./getusermedia.js')
          ...
          const _getdisplaymedia = require('./getdisplaymedia.js')
      ...
      6: [
        function (require, module, exports) {
          ...
          function shimRTCIceCandidateRelayProtocol(window) {
            ...
            utils.wrapPeerConnectionEvent(window, 'icecandidate', function (e) {
              if (e.candidate) {
                const parsedCandidate = _sdp2.default.parseCandidate(e.candidate.candidate)
      ...
      12: [
        function (require, module, exports) {
          ...
          SDPUtils.parseRtpEncodingParameters = function (mediaSection) {
            ...
            const flows = SDPUtils.matchPrefix(mediaSection, 'a=ssrc-group:FID').map(
              function (line) {
